...
class UnrealController:
    ...
    def request_redraw(self):
        """Method 2: UnrealEditorSubsystem.RequestRedrawActiveViewport"""
        url = f'{self.base_url}/remote/object/call'
        payload = {
        ...
        try:
            ...
            if response.status_code == 200:
                print("    ✓ RequestRedraw succeeded")
                return True
            else:
                print(f"    ✗ RequestRedraw failed: {response.json().get('errorMessage', 'Unknown')}")
                return False
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("METHOD 2: UnrealEditorSubsystem.RequestRedrawActiveViewport")
    print("="*60)
