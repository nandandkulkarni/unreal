...
module_path = os.path.join(script_dir, "motion_system")
...
import hud_setup
import visual_aids
import motion_planner      # NEW: Pass 1 - Commands to keyframes
import keyframe_applier    # NEW: Pass 2 - Keyframes to Unreal
