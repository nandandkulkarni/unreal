...
MOVIE = {
    ...
    "plan": [
        ...
        {"command":"add_camera","actor":"Corner1Cam","location":[-800,-800,500],"rotation":[0,0,0],"fov":55,"tint":[0.5,0.5,1.0],"show_marker":"blue","look_at_actor":"Jessica","offset":[0,0,150],"interp_speed":5.0},
