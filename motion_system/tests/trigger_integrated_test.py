"""
Run Integrated Motion Test Suite
Reads `run_integrated_test.py` and executes it in Unreal Engine via Remote Control.
"""
import requests
import time
import os
...
def run_test():
    ...
    test_script_path = os.path.join(script_dir, "run_integrated_test.py")
    ...
    try:
        ...
        # Ensure main() is called regardless of __name__
